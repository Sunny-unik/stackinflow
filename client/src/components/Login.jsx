...
export default function Login(props) {
  ...
  function forgotpass() {
    ...
    if (email === '') {
      ...
      setrandomotp(random);
      axios
        .post(`${process.env.REACT_APP_API_URL}/send-otp-email`, { email, otp: random })
        .then(res => {
          if (res.data.status === 'ok') {
            alert('otp sent to your email');
            document.getElementById('logindetail').style.display = 'none';
            document.getElementById('loginotp').style.display = 'block';
          } else alert('this email or username are not registered');
        });
    }
  }
  ...
  function otplogin() {
    if (
      ...
      axios
        .post(`${process.env.REACT_APP_API_URL}/update-password`, { email, newpassword })
        .then(res => {
          alert(res.data.data);
        });
        ...
        <div className='container logincon'>
          ...
          >
            ...
            >
              ...
              <hr className='signuphr' />
              <p className='forgotpasslink'>
                <span className='forgotpasslink' onClick={forgotpass}>
                  Forgot Password ?
                </span>
              </p>
            </form>
          ...
          >
            ...
            >
              ...
              <hr className='signuphr' />
              <label for='otplogin' className='otpemail'>
          ...
          >
            ...
            >
              ...
              <hr className='signuphr' />
              <label for='newpassword' className='newpassword'>
              ...
              <input
                ...
                required
              />
              <label for='confirmpassword' className='confirmpassword'>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
                <button
                  type='button'
                  onClick={cancellog}
                  className='bg-warning cancellogbtn'
                  style={{
