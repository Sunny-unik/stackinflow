    ...
    <div>
      <div>
        ...
        <div>
          ...
          {handleDate(qdate) !== 0 ? 'on ' + handleDate(qdate) + ' day ago' : 'today'}.
        </div>
            ...
            <div className='m-2 mb-0' key={a.uid}>
              <div className='answersec'>
                ...
                <div className='col-sm-4 mx-2'>
                  ...
                  <br />{' '}
                  {handleDate(a.date) !== 0 ? 'on ' + handleDate(a.date) + ' day ago' : 'today'}.
                </div>
              </div>
            </div>
          );
      ...
      <form>
        <div className='col-sm-11 '>
          <textarea
            ...
            name='seta'
            id='seta'
            style={{ height: '30vh', marginBottom: '.6rem', fontSize: '1.4rem' }}
          ></textarea>
        </div>
