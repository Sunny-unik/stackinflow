  ...
  return (
    <React.Fragment>
      ...
      <div id='hiddennav' className='py-2 px-2'>
        ...
        <br />
        <br />
        <NavLink activeClassName='active1' to='/Profile' onClick={closeSlideMenu}>
          <FaUserTie /> Profile{' '}
        </NavLink>
        <br />
        <br />
        ...
        <div className='d-md-flex'>
          ...
          >
            ...
            <div className='text-center'>
              ...
              <div>
                <h2 className='my-0' style={{ fontFamily: 'Sans-Serif', fontWeight: 'bold' }}>
                  {name}
                </h2>
              </div>
              <label style={{ fontFamily: 'SeogUI' }}>Display Name</label>
              <div>
                <h3 style={{ fontFamily: 'Sans-Serif', fontWeight: 'bold' }}>{dname}</h3>
              </div>
              {title && (
                <div>
              ...
              <h3 style={{ fontFamily: 'Sans-Serif', fontWeight: 'bold' }}>{email}</h3>
              {address && (
                <div>
