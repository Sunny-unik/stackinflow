  ...
  return (
    <div className="w-100 m-0 p-md-4 p-sm-2">
      ...
      <div>
        <i>
          ...
          <p className="display-6 w-100">
            ...
            Stackinflow for Teams, is transforming how people work.
          </p>
        </i>
      </div>
      <br />
      <div
        ...
        style={{ boxShadow: "0.1em 0.1em 0.2em 0.2em skyblue" }}
      >
        <div className="col-md-5 d-inline-block p-2">
          <h6>
            Published in 2022, Stackinflow's public platform is used by nearly
            everyone who codes to learn, share their knowledge, collaborate, and
            build their careers.
          </h6>
          <br />
          <h6>
            Our products and tools help developers and technologists in life and
            at work. These products include Stackinflow for Teams, Stackinflow
            Share knowledge and solve questions.
          </h6>
        </div>
        <div className="col-md-5 d-inline-block p-2">
          <h6>
            Whether it’s on Stackinflow or within Stackinflow for Teams,
            community is at the center of all that we do.
          </h6>
          <br />
          <h6>
            Stackinflow for Teams, our core SaaS collaboration product, is
            helping thousands of peoples around the world make the transition to
            remote work, address business continuity challenges, and undergo
      ...
      <div className="m-auto card-header">
        <div className="text-center col-sm-12 p-3 display-6">
          {" "}
          Our Core Values{" "}
        </div>
        <div className="justify-content-center w-100 d-md-flex">
          ...
          <div className="col-sm-11 col-md-4 col-lg-4 d-inline-block p-2">
            ...
            <p>
              ...
              an environment of respect and trust. Create space for different
              voices to be heard, and allow flexibility in how people work.
            </p>
          </div>
          <div className="col-sm-11 col-md-4 col-lg-4 d-inline-block p-2">
            <div className="display-4 text-primary text-center">
